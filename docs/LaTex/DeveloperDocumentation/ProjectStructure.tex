...
\begin{figure}[H]
	...
	\includegraphics[width=0.3\textwidth]{help_screen_LIGHT}
\end{figure}
\begin{itemize}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.3\textwidth]{trainer_screen_light}
\end{figure}
\begin{itemize}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.3\textwidth]{user_settings_light}
\end{figure}
\begin{itemize}
