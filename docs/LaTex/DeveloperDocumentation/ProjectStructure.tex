...
\begin{itemize}
	...
	\item \en{AddScreenState} \en{Contains the state of the add screen.} \de{Speichert den Zustand der Hinzufügen Ansicht.}
...
\begin{itemize}
	...
	\item \en{EditTimelineScreenState} \en{Contains the state of the edit-configuration screen.} \de{Speichert den Zustand der Konfiguration bearbeiten Ansicht.}
...
\begin{itemize}
	...
	\item \en{HomeScreenState} \en{Contains the state of the home screen.} \de{Speichert den Zustand der Home Ansicht.}
...
\begin{itemize}
	...
	\item \en{SelectScreenState} \en{Contains the state of the select screen.} \de{Speichert den Zustand der Auswahl Ansicht.}
...
\begin{itemize}
	...
	\item \en{SettingsScreenState} \en{Contains the state of the default settings screen.} \de{Speichert den Zustand der Standard Einstellungen Ansicht.}
...
\begin{itemize}
	...
	\item \en{SoundScreenState} \en{Contains the state of the sound screen.} \de{Speichert den Zustand der Sound Ansicht.}
